...
export default function BackScreen() {
    ...
    return (
        <View style={style.container}>
            ...
            <View>
                <Text style={style.txtSaldo}>Seu saldo:</Text>
                <Text style={style.txtSaldoValor}>{saldo.toFixed(2)}</Text>
            </View>
            <View>
                <TextInput
            ...
            <View style={style.botoes}>
                ...
                <Pressable style={style.botao} onPress={() => openConfirmationModal('sacar')}>
                    <Text style={style.txt}>Retirar</Text>
                </Pressable>
            </View>
            <Modal
                transparent={true}
